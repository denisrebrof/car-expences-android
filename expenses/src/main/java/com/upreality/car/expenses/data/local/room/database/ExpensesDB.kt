package com.upreality.car.expenses.data.local.room.database

import androidx.room.Database
import androidx.room.RoomDatabase
import com.upreality.car.expenses.data.local.room.expenses.dao.ExpensesDao
import com.upreality.car.expenses.data.local.room.expenses.dao.details.FinesDetailsDao
import com.upreality.car.expenses.data.local.room.expenses.dao.details.FuelDetailsDao
import com.upreality.car.expenses.data.local.room.expenses.dao.details.MaintenanceDetailsDao
...
import com.upreality.car.expenses.data.local.room.expensesinfo.dao.ExpenseInfoDAO
