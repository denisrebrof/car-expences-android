...
//        expensesFirestoreDataSource.get(ExpenseRemoteFilter.Created).flatMapSingle {
...
//        }
//
//        expensesFirestoreDataSource.get(ExpenseRemoteFilter.Updated).flatMap { updatedRemoteExpenses ->
